...
import type { Age, BMRAndExercise, BMREquation, ExerciseMultiplier, Genre, Goal, Height, LBM, LBMFormula, Weight } from './types'
import { calculateAge, getExerciseMultiplierValue } from './utils/global'

	...
	return (
		<div className='w-full space-y-2'>
			...
			<div className='flex gap-2'>
				<div className={`chamfered bg-obsidian relative p-0.5 ${showManualLBMInput ? 'w-3/5' : 'w-full'}`}>
					<select id='LBMFormula' name='LBMFormula' defaultValue={lbm.formula} onChange={handleLBMFormulaChange} className={selectStyles}>

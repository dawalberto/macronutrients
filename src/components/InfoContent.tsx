		...
		<>
			...
			<div className='flex flex-col gap-8'>
				...
				<section className='brutalist-border bg-obsidian p-6'>
					...
					<h2 className='mb-4 text-xl font-extrabold italic border-b-2 border-[#4A4A4A] pb-2'>{t.info_lbm_title}</h2>
					...
					<div className='space-y-4'>
						<div className='border-l-4 border-gray-100 pl-4'>
							...
							<p className='text-[clamp(10px,1vw,11px)] text-concrete'>Male: 0.407 × W + 0.267 × H − 19.2</p>
							<p className='text-[clamp(10px,1vw,11px)] text-concrete'>Female: 0.252 × W + 0.473 × H − 48.3</p>
						...
						<div className='border-l-4 border-[#4A4A4A] pl-4'>
							...
							<p className='text-[clamp(10px,1vw,11px)] text-concrete'>Male: 1.1 × W − 128 × (W/H)²</p>
							<p className='text-[clamp(10px,1vw,11px)] text-concrete'>Female: 1.07 × W − 148 × (W/H)²</p>
						...
						<div className='border-l-4 border-[#4A4A4A] pl-4'>
							...
							<p className='text-[clamp(10px,1vw,11px)] text-concrete'>Male: 0.3281 × W + 0.33929 × H − 29.5336</p>
							<p className='text-[clamp(10px,1vw,11px)] text-concrete'>Female: 0.29569 × W + 0.41813 × H − 43.2933</p>
						</div>

						<div className='border-l-4 border-[#4A4A4A] pl-4'>
							<p className='mb-1 text-[clamp(11px,1.2vw,13px)] font-bold'>MANUAL</p>
							<p className='text-[clamp(10px,1vw,11px)] text-concrete'>{t.info_lbm_manual_desc}</p>
						</div>
					</div>
				</section>
				...
				<section className='brutalist-border bg-obsidian p-6'>
					...
					<h2 className='mb-4 text-xl font-extrabold italic border-b-2 border-[#4A4A4A] pb-2'>{t.info_bmr_title}</h2>
					...
					<div className='space-y-4'>
						<div className='border-l-4 border-[#4A4A4A] pl-4'>
							...
							<p className='text-[clamp(10px,1vw,11px)] text-concrete'>Male: 10W + 6.25H − 5A + 5</p>
							<p className='text-[clamp(10px,1vw,11px)] text-concrete'>Female: 10W + 6.25H − 5A − 161</p>
						...
						<div className='border-l-4 border-[#4A4A4A] pl-4'>
							...
							<p className='text-[clamp(10px,1vw,11px)] text-concrete'>Male: 13.397W + 4.799H − 5.677A + 88.362</p>
							<p className='text-[clamp(10px,1vw,11px)] text-concrete'>Female: 9.247W + 3.098H − 4.33A + 447.593</p>
						...
						<div className='border-l-4 border-gray-100 pl-4'>
							...
							<p className='text-[clamp(10px,1vw,11px)] text-concrete'>370 + 21.6 × LBM (kg)</p>
				...
				<section className='brutalist-border bg-obsidian p-6'>
					...
					<h2 className='mb-4 text-xl font-extrabold italic border-b-2 border-[#4A4A4A] pb-2'>{t.info_tdee_title}</h2>

					<div className='mb-4 text-[clamp(11px,1.2vw,13px)]'>
						<p className='text-gray-300'>{t.info_tdee_desc}</p>
						<p className='mt-2 font-bold text-[clamp(10px,1vw,11px)] text-concrete'>{t.info_tdee_formula}</p>
					</div>
				...
				<section className='brutalist-border bg-obsidian p-6'>
					...
					<h2 className='mb-4 text-xl font-extrabold italic border-b-2 border-[#4A4A4A] pb-2'>{t.info_goals_title}</h2>

					<div className='space-y-4'>
						<div className='border-l-4 border-gray-100 pl-4'>
							<p className='mb-1 text-[clamp(11px,1.2vw,13px)] font-bold'>{t.goal_maintain.toUpperCase()}</p>
							<p className='text-[clamp(10px,1vw,11px)] text-concrete'>{t.info_goal_maintain_formula}</p>
						...
						<div className='border-l-4 border-[#4A4A4A] pl-4'>
							...
							<p className='text-[clamp(10px,1vw,11px)] text-concrete'>{t.info_goal_surplus_formula}</p>
						...
						<div className='border-l-4 border-[#4A4A4A] pl-4'>
							...
							<p className='text-[clamp(10px,1vw,11px)] text-concrete'>{t.info_goal_definition_formula}</p>
				...
				<section className='brutalist-border bg-obsidian p-6'>
					...
					<h2 className='mb-4 text-xl font-extrabold italic border-b-2 border-[#4A4A4A] pb-2'>{t.info_macros_title}</h2>
					...
					<div className='mt-4 border-t-2 border-dashed border-[#4A4A4A] pt-4'>
						...
						<p className='mt-1 text-[clamp(10px,1vw,11px)] text-concrete'>{t.info_carbs_formula}</p>
					</div>
				</section>
			</div>

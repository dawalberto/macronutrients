...
export const hi = {
	...
	seo_home_description:
		'अपने वज़न, ऊंचाई, उम्र, एक्टिविटी लेवल और लक्ष्य के आधार पर दैनिक प्रोटीन, कार्ब्स और फैट की ज़रूरत कैलकुलेट करें। Katch-McArdle BMR और LBM फ़ॉर्मूले का उपयोग करता है।',
	seo_home_keywords:
		'मैक्रोन्यूट्रिएंट कैलकुलेटर, मैक्रो कैलकुलेटर, प्रोटीन कैलकुलेटर, TDEE कैलकुलेटर, BMR कैलकुलेटर, लीन बॉडी मास, वज़न घटाने की कैलोरी, मसल गेन मैक्रो',
	...
	seo_info_description:
		'LBM, BMR, TDEE और मैक्रोन्यूट्रिएंट फ़ॉर्मूले समझाए गए। Boer, James, Hume, Mifflin-St Jeor, Harris-Benedict, Katch-McArdle।',
